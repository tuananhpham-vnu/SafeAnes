...
"""E08: chốt biến thể gaussian_jitter_3x làm model thay lightgbm_monotone trong ensemble.

Train lại LightGBM với Gaussian-jitter augmentation trên window dương (giống
stage1_data_methods.py, biến thể gaussian_jitter_3x — đã cho PPV tốt nhất tại cùng mức
recall ở cả hai horizon). Lưu bundle + prediction validation vào artifacts/E08/ để các script
Giai đoạn 2-4 dùng lại, thay cho lightgbm_monotone của E06. Không đổi bundle/threshold E05/E06
đã khóa; đây là artifact mới của E08.
"""
import json
...
def main():
    ...
    print(f"Đã thêm {NAME} vào {ceiling_path}")
