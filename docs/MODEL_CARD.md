...
| Kết quả | [Tổng hợp v0.2](../reports/v0_2/REPORT.md), [E05: 300 ca/ba seed/ablation](../reports/E05/REPORT.md), [CI subgroup/lead time](../reports/E05/SUBGROUPS.md). Kết quả cohort lớn chưa đạt đầy đủ gate; không suy chất lượng từ pilot 60 ca. |
| Tính nhất quán horizon | Có p600<p300 ở một phần window tabular do train/calibrate độc lập; số cụ thể trong [E05 verification](../reports/E05/verification.json) và [E04](../reports/v0_4/verification.json). Không diễn giải hai đầu ra như risk có thứ tự. |
...
Mỗi checkpoint phải đi kèm preprocessing, feature order, protocol/data hashes, calibrator và threshold đúng policy. NIBP thưa không được thay thế trực tiếp MAP động mạch. Tái lập: [sequence runbook](SEQUENCE_RUNBOOK.md), [E04 runbook](versions/V0_4_RUNBOOK.md).
...
E06 dùng lại holdout E05, nên toàn bộ [kết quả thay thế](../reports/E06/REPORT.md) là exploratory.
